...
from ls.joyous.formats.ical import (
    CalendarTypeError,
...
class Test(TestCase):
    ...
    def testFromCalendarPage(self):
        page = RecurringEventPage(
            ...
            title="Chess",
            repeat=Recurrence(
                dtstart=dt.date(2000, 1, 1), freq=WEEKLY, byweekday=[MO, WE, FR]
            ),
    ...
    def testFromEventPageClosedHolidays(self):
        ...
        page = RecurringEventPage(
            ...
            title="Chess",
            repeat=Recurrence(
                dtstart=dt.date(2020, 1, 1), freq=WEEKLY, byweekday=[MO, WE, FR]
            ),
            time_from=dt.time(12),
            time_to=dt.time(13),
        ...
        props = [
            ...
            b",20251027T120000,20251103T120000,20251114T120000,20251201T120000",
            b"20281204T120000,20281225T120000,20290101T120000,20290122T120000,",
            b",20341117T120000,20341127T120000,20341204T120000,20341225T120000,",
            b",20361201T120000,20361226T120000,20370102T120000,20370119T120000,",
            b",20381112T120000,20381129T120000,20381227T120000",
    ...
    def testFromUnsupported(self):
        page = Page(owner=self.user, slug="thoughts", title="My thoughts for today")
...
class TestUpdate(TestCase):
    ...
    def setUp(self):
        ...
        event = RecurringEventPage(
            ...
            repeat=Recurrence(
                dtstart=dt.date(2018, 3, 29), freq=WEEKLY, byweekday=[TH]
            ),
...
class TestNoCalendar(TestCase):
    ...
    def setUp(self):
        ...
        self.event = RecurringEventPage(
            ...
            title="Chess Matches",
            repeat=Recurrence(
                dtstart=dt.date(2012, 8, 1), freq=WEEKLY, byweekday=[MO, WE, FR]
            ),
            time_from=dt.time(12),
            time_to=dt.time(13),
        )
