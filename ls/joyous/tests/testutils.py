...
def freeze_timetz(time_to_freeze=None, tz_offset=__abracadabra, *args, **kwargs):
    ...
    if isinstance(time_to_freeze, dt.datetime) and timezone.is_naive(time_to_freeze):
