...
class Test(TestCase):
    ...
    def testCurrentDt(self):
        self.assertEqual(
            self.postponement._current_datetime_from, datetimetz(1990, 1, 9, 13, 0)
        )
    ...
    def testPastDt(self):
        self.assertEqual(
            self.postponement._past_datetime_from, datetimetz(1990, 1, 9, 13, 0)
        )
