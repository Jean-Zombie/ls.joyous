...
class TestFeed(TestCase):
    ...
    def testServe(self):
        ...
        self.assertEqual(
            channel.lastBuildDate.string, "Fri, 02 Dec 2016 00:00:00 +0000"
        )
...
&lt;div class="rich-text"&gt;&lt;/div&gt;\n</description>""",
    ...
    def testServeUnsupported(self):
        response = self.handler.serve(self.event, self._getRequest("/events/workshop"))
    ...
    def testServeExtraInfo(self):
        ...
        self.assertEqual(
            item.link.string, "http://joy.test/events/workshop/2017-02-07-extra-info/"
        )
        self.assertEqual(
            item.enclosure.decode(),
            '<enclosure length="773" type="image/png" '
...
&lt;div class="rich-text"&gt;&lt;/div&gt;\n</description>""",
        ...
        self.assertEqual(item.guid.get("isPermaLink"), "true")
        self.assertEqual(
            item.guid.string, "http://joy.test/events/workshop/2017-02-07-extra-info/"
        )
    ...
    def testServePostponement(self):
        ...
        self.assertEqual(
            item1.link.string,
            "http://joy.test/events/workshop/2017-04-04-postponement/from/",
        )
        self.assertEqual(
            item1.enclosure.decode(),
            '<enclosure length="773" type="image/png" '
            'url="http://joy.test/media/images/{}"/>'.format(self.rendName),
        )
        self.assertEqual(
            item1.description.decode(),
            """<description>\n\n\n
  &lt;div class="joy-ev-when joy-field"&gt;
...
&lt;div class="rich-text"&gt;Interesting stuff&lt;/div&gt;\n</description>""",
    ...
    def testServeCancellation(self):
        ...
        self.assertEqual(
            item.link.string, "http://joy.test/events/workshop/2017-05-02-cancellation/"
        )
        self.assertEqual(
            item.enclosure.decode(),
            '<enclosure length="773" type="image/png" '
...
&lt;div class="rich-text"&gt;No workshop this month&lt;/div&gt;\n</description>""",
        ...
        self.assertEqual(item.guid.get("isPermaLink"), "true")
        self.assertEqual(
            item.guid.string, "http://joy.test/events/workshop/2017-05-02-cancellation/"
        )
